    ...
    <div className="container max-w-6xl mx-auto py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="md:col-span-1">
          <Card className="overflow-hidden border-border/30 hover-card-effect shadow-sm">
            <div className="bg-primary/5 p-8 flex flex-col items-center">
              <AvatarUpload
                initialAvatarUrl={avatarUrl}
                email={user.email}
              />
              <h2 className="text-xl font-bold mt-4">{user.email?.split('@')[0]}</h2>
              <p className="text-muted-foreground mt-2 text-sm break-all text-center">{user.email}</p>
            </div>
        ...
        <div className="md:col-span-2">
          <Card className="border-border/30 hover-card-effect shadow-sm h-full">
            ...
            <CardContent>
              <div className="space-y-8">
                <div>
                  ...
                  <div className="bg-muted/30 rounded-lg p-5 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        <p className="text-xs text-muted-foreground mb-1">邮箱地址</p>
                ...
                <div>
                  ...
                  <div className="bg-muted/30 rounded-lg p-5">
                    <div>
                      <p className="text-xs text-muted-foreground mb-1">上次登录时间</p>
